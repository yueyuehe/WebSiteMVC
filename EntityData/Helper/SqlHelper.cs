...
namespace Common
{
    ...
    public class SqlHelper
    {
        ...
        /// <param name="commandParameters"></param>
        /// <returns></returns>
        public static DataTable ExecuteDataTable(SqlTransaction tran, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            var dataSet = ExecuteDataset(tran, commandType, commandText, commandParameters);
            if (dataSet != null && dataSet.Tables.Count > 0)
            {
                return dataSet.Tables[0];
            }
